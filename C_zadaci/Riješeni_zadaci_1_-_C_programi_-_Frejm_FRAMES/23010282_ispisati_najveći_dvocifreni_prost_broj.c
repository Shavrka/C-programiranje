/*
 * ZADATAK 23010282 - 23010282
 * Ispisati najveći dvocifreni prost broj.
 * Kategorija: Riješeni zadaci 1 - C programi - Frejm /FRAMES/
 * Izvor: https://www.znanje.org/knjige/computer/c/v/230c/23010282.htm
 */
...
printf("Najveci dvocifreni prost broj\n"); // naslov

for (x = 99; x >= 10; x--) { // dvocifreni brojevi - pocetak petlje
