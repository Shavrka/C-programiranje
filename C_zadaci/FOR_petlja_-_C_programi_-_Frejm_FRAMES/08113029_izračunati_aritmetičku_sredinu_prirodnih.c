/*
 * ZADATAK 08113029 - 08113029
 * Izračunati aritmetičku sredinu prirodnih brojeva od k do n koji su djeljivi sa a.
 * Kategorija: FOR petlja - C programi - Frejm /FRAMES/
 * Izvor: https://www.znanje.org/knjige/computer/c/v/081c/08113029.htm
 */
...
int main ()
{
printf("Aritmeticka sredina brojeva od k do n djeljivi sa a\n");
...
s = s + i;           // da, i djeljivao sa a, uvecaj s za vrijednosti i; s=s+i
