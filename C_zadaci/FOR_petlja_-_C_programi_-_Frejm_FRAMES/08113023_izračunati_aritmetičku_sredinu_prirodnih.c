/*
 * ZADATAK 08113023 - 08113023
 * Izračunati aritmetičku sredinu prirodnih brojeva od k do n.
 * Kategorija: FOR petlja - C programi - Frejm /FRAMES/
 * Izvor: https://www.znanje.org/knjige/computer/c/v/081c/08113023.htm
 */
...
int main ()
{
printf("Aritmeticka sredina brojeva od k do n\n");
int k, n, i;                 // deklarisanje varijabli
