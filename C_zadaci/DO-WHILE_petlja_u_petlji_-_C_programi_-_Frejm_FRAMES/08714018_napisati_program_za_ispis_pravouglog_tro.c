 ...
 * Izvor: https://www.znanje.org/knjige/computer/c/v/085c/08714018.htm
 */
...
if (j <= i)   // ispod glavne dijagonale?
printf("%d ", 2*j);  // dvostruka vrijednost indeksa j
j++;
